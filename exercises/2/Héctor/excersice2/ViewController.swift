...
class ViewController: UIViewController,AddBandDelegate,UITableViewDelegate,UITableViewDataSource{
    ...
    func makeConstraints() {
        ...
        tableView.bottomAnchor.constraintEqualToAnchor(margin.bottomAnchor).active = true
        tableView.leadingAnchor.constraintEqualToAnchor(margin.leadingAnchor).active = true
        tableView.trailingAnchor.constraintEqualToAnchor(margin.trailingAnchor).active = true
    }
    ...
    func buttonTapped(button: UIButton) {
        let secondViewController = AddBandViewController()
